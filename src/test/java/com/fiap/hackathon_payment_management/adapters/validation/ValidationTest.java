...
public class ValidationTest {
    ...
    public ValidationTest() {
        ...
        this.paymentValidations.add(new ValidateCreditCard());
    ...
    void paymentValidations_CPF_Invalid_Test() {
        ...
        assertThrows(ValidationException.class, () -> paymentValidations.forEach(validator -> validator.validate(requestDto)), "Cartão de crédito não pertence a esse cliente.");
    ...
    void paymentValidations_VALUE_NEGATIVE_Invalid_Test() {
        ...
        assertThrows(ValidationException.class, () -> paymentValidations2.forEach(validator -> validator.validate(requestDto)), "Cartão de crédito não pertence a esse cliente.");
