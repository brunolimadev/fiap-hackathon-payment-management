...
class ValidateCreditCardTest {
  ...
  void validate_InvalidCvv_ValidationExceptionThrown() {
    ...
    CreditCardResponseDto creditCard = new CreditCardResponseDto("", cpf, 1000.00, numero, dataValidade, "123");
  ...
  void validate_InvalidDataValidade_ValidationExceptionThrown() {
    ...
    CreditCardResponseDto creditCard = new CreditCardResponseDto("", cpf, 1000.00, numero, "01/2022", cvv);
  ...
  void validate_DateBeforeCurrentDate_ValidationExceptionThrown() {
    ...
    CreditCardResponseDto creditCard = new CreditCardResponseDto("", cpf, 1000.00, numero, "01/10", cvv);
  ...
  void validate_ReachedCardLimit_ValidationLimitCardExceptionThrown() {
    ...
    // Act & Assert
    assertThrows(ValidationLimitCardException.class, () -> validateCreditCard.validate(requestDto));
  ...
  @Test
  void validate_InvalidCardNumber_ValidationExceptionThrown() {
    ...
    CreditCardResponseDto creditCard = new CreditCardResponseDto("", cpf, 1000.00, "5465 1946 1186 2987", dataValidade, cvv);
